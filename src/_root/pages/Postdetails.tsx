      ...
      {isPending? <Loader/>:(
        <div className="post_details-card">
          ...
          <div className="flex-center gap-4">
            ...
            <Button onClick={handledeletepost} variant="destructive" className={`post_details-delete_btn ${user.id !==post?.creator.$id && 'hidden'}`}>
            ...
            <div className="flex flex-col flex-1 small-meduim lg:base-regular">
            <p>{post?.caption}</p>
